...
void solve_ronit(int tc) {
    ...
    int ones = 0;
    int last_one_index_from_right = -1;
    ...
    for (int i = n - 1; i >= 0; i--)
    {
        ...
        {
            ones++;
            last_one_index_from_right = i;
        }
        
    }
    
    int ones_copy = ones;
    if (last_one_index_from_right == -1 || n - last_one_index_from_right == ones)
    {
        cout << "Bob" << endl;
        return;
    }
    else
    {
        ...
        // print Alice then size of set then set elements
        cout << "Alice" << endl;
        cout << zero_positions.size() << endl;
